...
const componentName = 'LyPagination'
...
export default defineComponent({
  ...
  props: {
    ...
    layout: {
      type: String,
      default: 'total, sizes, prev, pager, next, jumper', // 'prev, pager, next, jumper, ->, total'
    },
  ...
  setup(props, { emit, slots }) {
    ...
    const innerPageSize = ref(
      isAbsent(props.defaultPageSize) ? 50 : props.defaultPageSize
    )
