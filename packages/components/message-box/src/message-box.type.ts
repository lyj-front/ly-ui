...
export interface LyMessageBoxOptions {
...
export type LyMessageBoxShortcutMethod = ((
  message: LyMessageBoxOptions['message'],
  title: LyMessageBoxOptions['title'],
  options?: LyMessageBoxOptions
...
export interface IElMessageBox {
  ...
  /** Show a message box */
  (options: LyMessageBoxOptions): Promise<MessageBoxData>

  /** Show an alert message box */
  alert: LyMessageBoxShortcutMethod

  /** Show a confirm message box */
  confirm: LyMessageBoxShortcutMethod

  /** Show a prompt message box */
  prompt: LyMessageBoxShortcutMethod
