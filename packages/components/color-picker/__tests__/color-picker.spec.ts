...
describe('Color-picker', () => {
  it('Mount Color-picker', () => {
    ...
    expect(wrapper.html()).toContain('ly-color-picker')
    wrapper.unmount()
  })
  it('should show alpha slider when show-alpha=true', async () => {
    const wrapper = _mount(
      `<ly-color-picker v-model="color" :show-alpha="true"></ly-color-picker>`,
      () => ({
        color: '#20A0FF',
      })
    )
  ...
  it('should change saturation and value when clicking the sv-panel', async () => {
    const wrapper = _mount(
      `<ly-color-picker v-model="color" show-alpha color-format="hsv"></ly-color-picker>`,
      () => ({
        color: 'hsv(0, 50%, 50%)',
      })
    )
  ...
  it('should change color to the selected color', async () => {
    const wrapper = _mount(
      `<ly-color-picker v-model="color" show-alpha :predefine="colors"></ly-color-picker>`,
      () => ({
