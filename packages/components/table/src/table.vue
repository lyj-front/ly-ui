<template>
  <div
    ...
    :class="[
      {
        [ns.m('fit')]: fit,
        [ns.m('striped')]: border ? false : stripe,
    ...
    <div :class="ns.e('inner-wrapper')">
      ...
      <div ref="bodyWrapper" :class="ns.e('body-wrapper')">
        <ly-scrollbar
          ...
          :scrollBarPosition="layout.scrollBarPosition"
          :scrollBarFixed="layout.scrollBarFixed"
          ...
          >
            <span :class="ns.e('empty-text')">
              <slot name="empty">
                ...
                <span class="el-table__empty-font">{{ computedEmptyText }}</span>
              </slot>
            </span>
          </div>
          <div
