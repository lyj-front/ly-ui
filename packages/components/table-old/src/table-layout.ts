...
class TableLayout<T> {
  ...
  updateScrollY() {
    ...
    if (this.table.vnode.el && bodyWrapper) {
       ...
       */
      if (this.bodyHeight.value === null || this.propHeight === 'auto') {
        scrollY = false
      } else {
  ...
  async updateElsHeight() {
    ...
    this.fixedBodyHeight.value = this.scrollX.value
      ? this.bodyHeight.value - (this.gutterWidth?this.gutterWidth:this.scrollBarFixed?8:0)
      : this.bodyHeight.value

    this.viewportHeight.value = this.scrollX.value
      ? tableHeight - (this.gutterWidth?this.gutterWidth:this.scrollBarFixed?8:0)
      : tableHeight
    this.updateScrollY()
