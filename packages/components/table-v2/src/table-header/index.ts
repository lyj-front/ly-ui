...
import ExplainBtn from '../explain-btn.vue'
                  ...
                  [
                    h(
                      ...
                      [
                        ...
                        column.explain &&
                        h(ExplainBtn, { explainStr: column.explain }),
                        column.sortable &&
                        h(
                          'span',
                          {
                            ...
                            class: { 'caret-wrapper': true, 'always-show': this.sortAlwaysShow } ,
                          },
                          [
                            // h('i', {
                            //   onClick: ($event) =>
