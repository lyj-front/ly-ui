<template>
  ...
  >
      ...
      <div :class="['el-step__icon', `is-${icon ? 'icon' : 'text'}`]">
        ...
        <i
          ...
          :class="[
            ...
            'is-status',
            `el-icon-${
              currentStatus === 'success' ? 'circle-check' : 'circle'
            }`,
          ]"
        >
        </i>
      </div>
      <div class="el-step__main" v-if="isVertical && description.length">
    ...
    <!-- title & description -->
    <div class="el-step__main" v-if="!isVertical">
      <div v-if="isSimple" class="el-step__arrow"></div>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const parent: IStepsInject = inject('LySteps')
