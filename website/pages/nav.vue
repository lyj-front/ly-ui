  ...
  <div>
    ...
    <div class="block">
      ...
      <ly-row :gutter="20">
        ...
        <ly-col :span="15" class="nav-demos">
          <img
    ...
    <div class="block">
      ...
      <ly-row>
        ...
        <ly-col :span="14" class="nav-demos">
          <img
...
export default {
  ...
  computed: {
    langConfig() {
        cosnole.log(pageLang.filter((config) => config.lang === this.lang)[0].pages.nav)
