  ...
  <ly-scrollbar ref="componentScrollBar" class="page-component__scroll">
    <div class="page-container page-component">
      <ly-scrollbar class="page-component__nav">
        <side-nav :data="navsData" :base="`/${lang}/other`" />
      </ly-scrollbar>
      ...
      <ly-backtop v-if="showBackToTop" target=".page-component__scroll .el-scrollbar__wrap" :right="100" :bottom="50" />
    </div>
  </ly-scrollbar>
</template>
<script>
      ...
      return [
        {
          ...
          children: [
            ...
            {
              path: '/set-poster',
              name: this.langConfig[3],
            },
            {
              path: '/lyj-datepicker',
              name: this.langConfig[4],
            },
            {
              path: '/lyj-xlsx',
              name: this.langConfig[5],
            },
            {
              path: '/lyj-oa',
              name: this.langConfig[6],
            },
            {
              path: '/lyj-refresh',
              name: this.langConfig[7],
            },
            {
              path: '/wx-canvas-img',
              name: this.langConfig[8],
            },
            {
              path: '/ad-dialog-doc',
              name: this.langConfig[9],
            },
            {
              path: '/pdf-img-preview',
              name: this.langConfig[10],
            },
            {
              path: '/lazy-img-plugin',
              name: this.langConfig[11],
            },
            {
              path: '/lyj-public-sdk',
              name: this.langConfig[12],
            },
            {
              path: '/pdf-img-convert',
              name: this.langConfig[13],
            },
            {
              path: '/evaluate',
              name: this.langConfig[14],
            },
          ],
        },
      ]
