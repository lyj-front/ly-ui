      ...
      <div class="container">
        <h1>
          <router-link :to="`/${lang}`">
            ...
            <slot>
              <img
                src="../assets/images/lyj_logox2.png"
                alt="element-logo"
                class="nav-logo"
              />
              <img
                src="../assets/images/lyj_logo.png"
                alt="element-logo"
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <router-link active-class="active" :to="`/${lang}/miniprogram`">
              {{ langConfig.miniprogram }}
            </router-link>
          </li>
          <li class="nav-item">
            <router-link active-class="active" :to="`/${lang}/other`">
              {{ langConfig.other }}
            </router-link>
          </li>
          <li class="nav-item">
            <router-link active-class="active" :to="`/${lang}/otherdoc`">
              {{ langConfig.otherdoc }}
            </router-link>
          </li>
          <li class="nav-item">
...
export default {
  ...
  computed: {
    lang() {
      let langs = this.$route.path.split('/')[1];
      if(Object.keys(Language).includes(langs)){
        return langs
      }
      return Language.CN
    },
